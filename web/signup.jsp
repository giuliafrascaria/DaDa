...
<head>
    ...
    <title>DaDa - Login e Signup</title>
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="index.html">DaDa</a></h1>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="signup.jsp">Accesso</a></li>
                ...
                <div class="product-content-right">
                    <div class="woocommerce">
                                ...
                                <div class="col-1">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                            <label class="" for="billing_last_name">Cognome <abbr title="required" class="required">*</abbr>
                                            </label>
                        ...
                        <div class="form-row place-order">
                            ...
                            <input type="submit" data-value="Submit" value="Submit" id="place_order" name="woocommerce_checkout_place_order" class="button alt">
