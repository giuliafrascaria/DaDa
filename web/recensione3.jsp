...
<%
    System.out.println("recensione 3 inizio");

    if(check)
    {
%>
        <div style="text-align: center">
            <label style=" font-family: 'Titillium Web', sans-serif; font-size: 16px; padding: 12px 20px 12px 40px; color: black;"> Recensione Inviata con Successo</label>
...
%>
        <div style="text-align: center">
            ...
            Probabilmente hai già inviato una recensione per questo articolo</label>
            <form action="home.jsp">
                <input type="submit" name = "submit" value="Torna alla home" >
            </form>
        </div>
